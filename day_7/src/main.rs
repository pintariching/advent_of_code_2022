// Code copied from https://github.com/simonw/advent-of-code-2022-in-rust/blob/main/day_07/src/main.rs
// as I couldn't find a solution
...
fn main() {
    let file_contents = fs::read_to_string("day_7/input.txt").unwrap();
